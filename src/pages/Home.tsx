...
const Home = () => {
  return (
    <div className="grid grid-cols-1 min-[745px]:grid-cols-2 min-[1240px]:grid-cols-[1.2fr_1.4fr_1.2fr] gap-3 sm:gap-4 lg:gap-6">
      {/* Left Column - AboutMe */}
      <div className="min-w-0 min-[745px]:row-span-2 bg-[#141414] rounded-lg sm:rounded-xl p-[2px] shadow-[0_0_15px_rgba(0,0,0,0.6)] hover:shadow-[0_0_20px_rgba(0,0,0,0.7)] transition-shadow">
      ...
      <div className="min-[1240px]:col-start-3 min-[1240px]:row-start-1 min-[745px]:order-3 min-[1240px]:order-none bg-[#141414] rounded-lg sm:rounded-xl p-[2px] shadow-[0_0_15px_rgba(0,0,0,0.6)] hover:shadow-[0_0_20px_rgba(0,0,0,0.7)] transition-shadow min-w-0">
        <div className="h-full w-full bg-[#141414] rounded-[10px] p-4 sm:p-6 lg:p-7">
          <GitHubContributions />
        </div>
      </div>
