        ...
        <div className="flex-1 relative">
          <div className="flex items-center gap-2 mb-2">
            <div className="flex items-center gap-2 px-2 py-1 bg-red-500/5 rounded-full border border-red-500/15">
              ...
              <span
                className="text-gray-400 text-sm inline-block overflow-hidden whitespace-nowrap transition-all duration-300"
        ...
        <div className="bg-surface-1 rounded-xl p-4 border border-gray-800">
          ...
          >
            <span className="flex items-center gap-2 min-w-0">
              <svg className="w-4 h-4 text-accent-400 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
            ...
            <span className="flex-shrink-0 text-[11px] text-gray-500 group-hover:text-accent-300 transition-colors font-mono">
              MCP &rarr;
            </span>
          </button>
        </div>
