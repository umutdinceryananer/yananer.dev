    ...
    >
      ...
      >
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <section className="rounded-lg border border-gray-800 bg-surface-0 p-4">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-ink text-sm font-semibold">SKILL.md</h3>
              <span className="text-[10px] font-medium uppercase tracking-wide text-emerald-300/80 bg-emerald-500/10 border border-emerald-500/20 rounded px-1.5 py-0.5">No setup</span>
            </div>
          ...
          <section className="rounded-lg border border-accent-500/25 bg-gradient-to-b from-accent-500/[0.07] to-transparent p-4">
            <div className="flex items-center gap-2 mb-1">
              <svg className="w-4 h-4 text-accent-400 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
                <path strokeLinecap="round" strokeLinejoin="round" d="m3.75 13.5 10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75Z" />
              </svg>
              <h3 className="text-ink text-sm font-semibold">MCP server</h3>
              <span className="text-[10px] font-medium uppercase tracking-wide text-accent-300/90 bg-accent-500/10 border border-accent-500/25 rounded px-1.5 py-0.5">Live · interactive</span>
            </div>
            <p className="text-gray-500 text-xs leading-relaxed mb-2.5">
            ...
            <div className="mt-3">
              <p className="text-gray-500 text-[11px] font-medium uppercase tracking-wide mb-1.5">Add it to Claude</p>
              ...
              <p className="text-gray-500 text-[11px] mt-1.5">
                CLI: <code className="text-accent-300/90 font-mono">claude mcp add --transport http yananer {MCP_URL}</code>
              </p>
            </div>

            <div className="mt-3 pt-3 border-t border-gray-800/70">
              <p className="text-gray-500 text-[11px] font-medium uppercase tracking-wide mb-1.5">Tools your AI can call</p>
              <div className="flex flex-wrap gap-1.5">
                {TOOLS.map((t) => (
                  <code key={t} className="text-accent-300/90 text-[11px] font-mono bg-accent-500/10 border border-accent-500/15 rounded px-1.5 py-0.5">{t}</code>
                ))}
              </div>
            </div>
          </section>
