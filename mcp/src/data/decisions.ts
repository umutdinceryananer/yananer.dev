...
export interface Decision {
  ...
  tradeoffs: string[]
  /** Real file paths backing the WHAT (verify these). */
  evidence: string[]
...
export const decisions: Decision[] = [
  ...
  // Hisar (private) ADRs go here as { source: 'sterilized-adr', repo: 'hisar', ... }
  // once the sterilized versions are provided — each will carry the
  // "self-reported / not independently verifiable" caveat in the tool output.
]
